...
from reproblems.reproblem_python_ver.reproblem import CRE51

class CRE51_pymoo(ElementwiseProblem):
...
def initialize_cre51():
    cre51_instance = CRE51()
    problem = CRE51_pymoo(cre51_instance)
    return problem